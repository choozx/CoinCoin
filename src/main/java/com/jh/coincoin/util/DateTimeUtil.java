...
//	}
    ...
    public static long getPastTime(long time, int interval, int candleCount) {
        LocalDateTime localDateTime = DateTimeUtil.toDateTime(time);
        LocalDateTime pastTime = localDateTime.minusMinutes((long) interval * candleCount);
        return DateTimeUtil.toEpochMilli(pastTime);
    }
